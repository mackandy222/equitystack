...
Shared reference for the canonical TODOS.md format. Referenced by `/ship` and `/plan-ceo-review` (TODOS.md updates section) to ensure consistent TODO item structure.
...
## <Skill/Component>     ← e.g., ## Matching, ## Vesting, ## Legal, ## Infrastructure
...
**Sections:** Organize by skill or component (`## Matching`, `## Vesting`, `## Legal`, `## Accounting`, `## API`, `## Infrastructure`). Within each section, sort items by priority (P0 at top).
